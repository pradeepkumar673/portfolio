...
const Login = () => {
    return (
        <>
            <div className="fixed inset-0 z-0 bg-[url('/src/assets/4k-Red-Sun-Illuminating-Japanese-Temple-Mountain-Scene.jpg')] bg-cover bg-center" />
            <div className='fixed inset-0  bg-black/10 backdrop-blur-sm'></div>
            <div className="relative z-10 flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 ">
